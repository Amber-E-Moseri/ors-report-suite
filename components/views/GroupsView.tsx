  ...
  return (
    <div className="fade-in max-w-5xl mx-auto space-y-5">
      ...
      <div className="rounded-xl border px-4 py-3 text-sm flex flex-wrap items-center gap-2"
        ...
        <DatabaseZap size={16} />
        <span>
          Your directory now saves automatically in local storage. Use <strong>Export Backup</strong> if you want to move it to another device or keep a safety copy.
        </span>
      </div>
